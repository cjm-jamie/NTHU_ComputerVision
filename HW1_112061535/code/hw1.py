...
def main():
    ...
    image1 = cv2.cvtColor(cv2.imread(os.path.join(main_path, 'data', 'otter_2.bmp')), cv2.COLOR_BGR2RGB)
    image2 = cv2.cvtColor(cv2.imread(os.path.join(main_path, 'data', 'benedict_2.bmp')), cv2.COLOR_BGR2RGB)
